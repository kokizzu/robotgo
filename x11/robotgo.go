...
// Version is the robotgo-x11 backend version string.
const Version = "v0.1.0-x11"
...
// Nps represents a process (pid + name).
type Nps struct {
	Pid  int
	Name string
}

// GetVersion returns the robotgo-x11 version.
...
// --- Image helpers (pure Go, no X11 dependency) ---

// Save saves an image to a file. Format is chosen by the file extension.
...
// PadHex pads a hex color value to a 6-char lowercase string (e.g. "ff0000").
